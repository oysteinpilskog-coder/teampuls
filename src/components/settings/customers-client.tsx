        ...
        {modalMode !== 'closed' && (
          <>
            ...
            <motion.div
              ...
              className="tp-modal pointer-events-auto w-[540px] max-w-full max-h-[calc(100vh-10vh-1rem)] sm:max-h-[calc(100vh-12vh-2rem)] overflow-y-auto rounded-2xl p-4 sm:p-6 flex flex-col gap-4"
            >
